...
salt = nan(TimeLength,50,xmax-xmin+1,ymax-ymin+1);
    
% Load cube92-3day data within subset

for TimeInd = 1:TimeLength
    
salt(TimeInd,:,:,:) = permute(ncread(['/ds/projects/iomp/obs/ECCO2/cube92_real/SALT.nc/SALT.1440x720x50.' num2str(DateIndexVector(TimeInd,:)) '.nc'],'SALT',[Xloc(1) Yloc(1) 1 1],[Xloc(2)-Xloc(1)+1 Yloc(2)-Yloc(1)+1 Inf Inf]),[3 1 2]);
...
save(['cube92_3day_clima_salt_',RunName,'.mat'],'salt','-v7.3')
clear salt
