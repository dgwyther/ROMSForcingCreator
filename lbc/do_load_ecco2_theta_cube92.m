...
theta(TimeInd,:,:,:) = permute(ncread(['/ds/projects/iomp/obs/ECCO2/cube92_real/THETA_monthly.nc/THETA.1440x720x50.' num2str(monstr(TimeInd)) '.nc'],'THETA',[Xloc(1) Yloc(1) 1 1],[Xloc(2)-Xloc(1)+1 Yloc(2)-Yloc(1)+1 Inf Inf]),[3 1 2]);
