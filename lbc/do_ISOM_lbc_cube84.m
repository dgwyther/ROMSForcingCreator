...
do_ISOM_lbc_nc_cube84(bryname,grdname,'Lateral Boundaries Salt and Temp',[0 1 1 1],Vtransform, Vstretching, Tcline, theta_s,theta_b,20,N,[(30.4375/2):30.4375:(30.4375*12*(MaxYear-MinYear+1))-(30.4375/2)],[30.4375*12*(MaxYear-MinYear+1)],'clobber')
