...
uvel((TimeInd-1)*12+1:TimeInd*12,:,:,:) = permute(ncread(['/ds/projects/iomp/obs/ECCO2/cube92_real/UVEL_MonthlyFrom3Day.nc/UVEL_' num2str(year_ind(TimeInd)) '_MonMeans.nc'],'UVEL',[Xloc(1) Yloc(1) 1 1],[Xloc(2)-Xloc(1)+1 Yloc(2)-Yloc(1)+1 Inf Inf]),[4 3 1 2]);
end
