...
vvel = nan(TimeLength,50,xmax-xmin+1,ymax-ymin+1);
...
vvel(TimeInd,:,:,:) = permute(ncread(['/ds/projects/iomp/obs/ECCO2/cube92_real/VVEL.nc/VVEL.1440x720x50.' num2str(DateIndexVector(TimeInd,:)) '.nc'],'VVEL',[Xloc(1) Yloc(1) 1 1],[Xloc(2)-Xloc(1)+1 Yloc(2)-Yloc(1)+1 Inf Inf]),[3 1 2]);
...
save(['cube92_3day_clima_vvel_',RunName,'.mat'],'vvel','-v7.3')
clear vvel
