...
disp('loading COREv1 data') %%% Load data
...
disp('converting daily to monthly data') % Makes monthly climatologies from daily climatologies: 
...
if 1 % daily data
disp('gridding COREv1 to model grid')
