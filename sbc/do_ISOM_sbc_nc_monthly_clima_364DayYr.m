...
swft = [((364/12)/2):(364/12):(364)-((364/12)/2)]; %data at mid each month
shft = [((364/12)/2):(364/12):(364)-((364/12)/2)];
...
disp('inpainting nans in wind and flux fields...')
