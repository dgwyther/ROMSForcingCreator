...
disp('calculating average forcing state (time av. of climatology)')

shf = squeeze(nanmean(shf,1));
swf = squeeze(nanmean(swf,1));
su  = squeeze(nanmean(su,1));
sv  = squeeze(nanmean(sv,1));
