...
load(['ustress_grid_model_' num2str(MinYear) '_' num2str(MaxYear) '.mat'])
load(['vstress_grid_model_' num2str(MinYear) '_' num2str(MaxYear) '.mat'])

LeapYear = [1992:4:2040]; %leap years til 2040

if 1 % remove all feb-29 data 
